...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
		...
		assert balanceBefore - withdrawalAmount == balanceAfter:
			"testWithdrawal: TC1 FAILED XXX: balanceBefore + withdrawalAmount != balanceAfter";
			//System.out.format("testWithdrawal: balanceBefore = %.2f ; withdrawalAmount = %.2f ; balanceAfter = %.2f %s\n", 
	...
	public static void main(String[] args) {
		...
		testDeposits();
		testWithdrawals(); 
		//-- uncomment this call, when you have developed the test method (test case)
	}
